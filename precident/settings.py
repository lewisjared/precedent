...
SECRET_KEY = '6#%chg&%9op!tn5g((1beh@upe=5a$y+_cu@vzth6#s$0$vb$*'
...
INSTALLED_APPS = [
    ...
    'precident.apps.PrecidentConfig',
    'api.apps.ApiConfig',
    'rest_framework',
]
...
WSGI_APPLICATION = 'precident.wsgi.application'
